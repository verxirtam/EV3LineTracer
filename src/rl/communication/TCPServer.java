...
public class TCPServer
{
	...
	private void WriteSocketMessage(Socket socket, BufferedReader resultreader)
			throws IOException
	{
		try (
		// クライアントへの送信用出力ストリーム
	...
	private BufferedReader ReadSocketMessage(Socket socket) throws IOException
	{
		...
		BufferedReader in = new BufferedReader(new InputStreamReader(
				...
				// メッセージ本体
				BufferedWriter messagebodywriter = new BufferedWriter(
						messagebodystringwriter);)
		{
			// 一行目の読み込み
	...
	// 空行(\n\n)を受信するまで1行ずつmessagebodyに格納する
	public void ReadMassageBody(BufferedReader in, BufferedWriter messagebody)
			throws IOException
	{
